...
function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(() => {
    ...
    if (oauthError) return "La connexion avec Google a échoué. Veuillez réessayer.";
    return null;
  });
        ...
        <div className="bg-card border border-border rounded-2xl shadow-sm p-6 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-2 text-muted-foreground uppercase tracking-wide">ou</span>
            </div>
          </div>
